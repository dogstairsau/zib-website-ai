  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (!res.ok || !res.body) {
        ...
        if (res.status === 429) {
          setStatus(
            'Looks like you\'re running a few audits. <a href="mailto:michael.glasser@zibdigital.com.au?subject=Let\'s%20talk%20audits" style="color:inherit;text-decoration:underline;">Let\'s jump on a call instead.</a>',
            'error'
          );
          return;
        }
